...
public class Chest extends Collectible{
    ...
    public void draw() {
        ...
        Position detailPos;
        Tools.drawSquare(pos, 130, 100, new double[]{0.612, 0.435, 0.235, 1});
        detailPos = new Position(pos.getX(), pos.getY() + 40);
        Tools.drawSquare(detailPos, 140, 10, new double[]{0.612, 0.612, 0.612, 1});
        ...
        Tools.drawSquare(detailPos, 20, 20, lockColor);
